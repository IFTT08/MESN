...
def parse_option():
    ...
    parser.add_argument('-front_layer', help='Last layer of first model', type=str, default="scala4.0.relu")
    parser.add_argument('-end_layer', help='Last layer of second model', type=str, default="layer3.5.relu")
    parser.add_argument('-channel', help='Last layer of second model', type=int, default=1024)


    parser.add_argument('-t', '--trial', type=int, default=98, help='the experiment id')

    parser.add_argument('--backbone_path', type=str,
                        default='./save/models/selfdis/ResNet50_cifar100_lr_0.05_decay_0.0005_trial_1/ResNet50_best.pth',
                        help='teacher model snapshot')
    parser.add_argument('--fc_path', type=str,
                        default='./save/models/selfdis/ResNet50_cifar100_lr_0.05_decay_0.0005_trial_1/fc_best.pth',
                        help='teacher model snapshot')
...
def main():
    ...
    model=SimilarityNet(opt.backbone_path,opt.fc_path,opt.transform_path,opt.front_layer,opt.end_layer,opt.dataset,
    ...
    print("model",model)
    transformmodel46=model.transform46
    transformmodel14 = model.transform
    transformmodel14.train()
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        if test_acc > best_acc:
            ...
            transform14 = {
                'epoch': epoch,
                'model': transformmodel14.state_dict(),
                'best_acc': best_acc,
            ...
            save_file_transform14 = os.path.join(opt.save_folder, '{}_best.pth'.format('transform14'))
            torch.save(transform14, save_file_transform14)
