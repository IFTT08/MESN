...
from comparators import get_comparator_function
...
class ActivationComparator(ComparatorBaseClass):
    ...
    def __call__(self,
        ...
        # Final measurements
        train_loader, val_loader = get_cifar100_dataloaders(batch_size=batch_size, num_workers=0)


        accumulate_fn = partial(self._accumulate, measure_names)
        self.iterate_through_data(train_loader,
                                  group_at=group_at,
                                  stop_at=stop_at,
